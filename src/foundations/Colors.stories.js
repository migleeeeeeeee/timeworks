...
const GROUPS = [
    {
        ...
        description: "Indigo-violet brand colors. Drive primary actions, focus rings, and selected states across the system.",
        swatches: [
            {
...
function SwatchRow({ swatch }) {
    return (_jsxs("tr", { style: { borderBottom: "1px solid var(--color-layout-border-color)" }, children: [_jsx("td", { className: "py-4 pr-6 align-middle", children: _jsx("div", { className: "h-12 w-20 rounded-md", style: {
                        background: `var(${swatch.cssVar})`,
                        boxShadow: swatch.light ? "inset 0 0 0 1px rgba(17, 17, 17, 0.08)" : undefined,
                    }, "aria-label": `${swatch.name} swatch — ${swatch.value}` }) }), _jsx("td", { className: "py-4 pr-6 align-middle", children: _jsxs("div", { className: "flex flex-col gap-0.5", children: [_jsx("code", { className: "text-t2 font-mono", style: { color: "var(--color-primary-text-color)" }, children: swatch.name }), _jsx("code", { className: "text-t3 font-mono", style: { color: "var(--color-secondary-text-color)" }, children: swatch.cssVar })] }) }), _jsx("td", { className: "py-4 pr-6 align-middle whitespace-nowrap", children: _jsx("code", { className: "text-t2 font-mono", style: { color: "var(--color-primary-text-color)" }, children: swatch.value }) }), _jsx("td", { className: "py-4 align-middle", children: _jsx("span", { className: "text-t2", style: { color: "var(--color-secondary-text-color)" }, children: swatch.usage }) })] }));
}
function GroupSection({ group }) {
    return (_jsxs("section", { className: "flex flex-col gap-4", children: [_jsxs("header", { className: "flex flex-col gap-2", children: [_jsx("h2", { className: "text-h2 font-heading font-semibold", style: { color: "var(--color-primary-text-color)" }, children: group.title }), _jsx("p", { className: "text-t1 max-w-prose", style: { color: "var(--color-secondary-text-color)" }, children: group.description })] }), _jsxs("table", { className: "w-full border-collapse text-left", children: [_jsx("thead", { children: _jsxs("tr", { style: { borderBottom: "1px solid var(--color-ui-border-color)" }, children: [_jsx("th", { className: "text-t3 pb-3 pr-6 font-semibold uppercase tracking-wide", style: { color: "var(--color-secondary-text-color)", width: "120px" }, children: "Sample" }), _jsx("th", { className: "text-t3 pb-3 pr-6 font-semibold uppercase tracking-wide", style: { color: "var(--color-secondary-text-color)", width: "320px" }, children: "Token" }), _jsx("th", { className: "text-t3 pb-3 pr-6 font-semibold uppercase tracking-wide", style: { color: "var(--color-secondary-text-color)", width: "200px" }, children: "Value" }), _jsx("th", { className: "text-t3 pb-3 font-semibold uppercase tracking-wide", style: { color: "var(--color-secondary-text-color)" }, children: "Usage" })] }) }), _jsx("tbody", { children: group.swatches.map((s) => (_jsx(SwatchRow, { swatch: s }, s.cssVar))) })] })] }));
}
function ColorsSheet() {
    return (_jsxs("div", { className: "flex flex-col gap-12 px-10 py-10", style: { background: "var(--color-primary-background-color)", color: "var(--color-primary-text-color)" }, children: [_jsxs("div", { className: "flex max-w-3xl flex-col gap-3", children: [_jsx("h1", { className: "text-h1 font-heading font-bold", children: "Colors" }), _jsxs("p", { className: "text-t1", style: { color: "var(--color-secondary-text-color)" }, children: ["The TimeWorks color palette. Each color is exposed as a CSS custom property in", " ", _jsx("code", { style: { color: "var(--color-primary-text-color)" }, children: "src/index.css" }), " under Tailwind v4\u2019s", " ", _jsx("code", { style: { color: "var(--color-primary-text-color)" }, children: "@theme" }), " block, which makes it available as a utility (e.g.", " ", _jsx("code", { style: { color: "var(--color-primary-text-color)" }, children: "bg-primary-color" }), ",", " ", _jsx("code", { style: { color: "var(--color-primary-text-color)" }, children: "text-text-primary" }), ")."] }), _jsxs("p", { className: "text-t1", style: { color: "var(--color-secondary-text-color)" }, children: ["Components must consume colors through these tokens \u2014 never hardcode a hex value or write a literal raw color in component code. Sourced verbatim from the Figma file (page \u201C\u25A0 Colors\u201D, node 46814:454) via the Tokens Studio export at", " ", _jsx("code", { style: { color: "var(--color-primary-text-color)" }, children: "src/tokens/source/Color Tokens/" }), "."] })] }), GROUPS.map((g) => (_jsx(GroupSection, { group: g }, g.title)))] }));
}
const meta = {
