...
const helperCls = cva("font-body text-t2 leading-5 text-[var(--color-secondary-text-color)]", {
    variants: {
        tone: {
...
export const TextArea = forwardRef(function TextArea({ size = "lg", state = "default", value, defaultValue, onValueChange, label, required = false, helperText, characterLimit, noResize = false, rows = 4, placeholder = "Users can type here", className, wrapperClassName, id, ...rest }, ref) {
    ...
    return (_jsxs("div", { className: "flex w-full flex-col gap-1", children: [label && (_jsxs("label", { htmlFor: fieldId, className: "flex gap-1 text-t2 leading-5 font-body text-[var(--color-primary-text-color)]", children: [_jsx("span", { children: label }), required && (_jsx("span", { "aria-hidden": true, className: "text-[var(--color-negative-color)]", children: "*" }))] })), _jsxs("div", { "data-state": state, className: cn(wrapper({ state }), wrapperClassName), children: [_jsx("textarea", { ref: textareaRef, id: fieldId, value: currentValue, onChange: handleChange, placeholder: placeholder, rows: rows, disabled: isDisabled, readOnly: isReadOnly, required: required, maxLength: characterLimit, "aria-invalid": state === "error" || undefined, className: cn(inputCls({ size }), noResize ? "resize-none" : "resize-y", className), ...rest }), !isReadOnly && !noResize && (_jsxs("svg", { "aria-hidden": true, viewBox: "0 0 8 8", className: "pointer-events-none absolute bottom-px right-px size-2 text-[var(--color-secondary-text-color)]", children: [_jsx("path", { d: "M7 1 L1 7", stroke: "currentColor", strokeWidth: "1", fill: "none" }), _jsx("path", { d: "M7 4 L4 7", stroke: "currentColor", strokeWidth: "1", fill: "none" })] }))] }), showBottom && (_jsxs("div", { className: "flex items-start justify-between gap-1 w-full", children: [_jsx("p", { className: cn(helperCls({ tone: helperTone }), "flex-1 min-w-0"), children: helperText }), characterLimit != null && (_jsxs("p", { className: cn(helperCls({ tone: helperTone }), "shrink-0 tabular-nums"), children: [currentValue.length, "/", characterLimit] }))] }))] }));
});
