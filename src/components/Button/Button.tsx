  ...
  ].join(" "),
  {
    variants: {
      size: {
        ...
        sm: "h-8 min-w-[55px] px-2 gap-2 text-t2 rounded-full",
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        color: "inverted",
        class:
          "border-[var(--color-ui-border-color)] text-[var(--color-primary-text-color)] hover:bg-[var(--color-primary-background-hover-color)] active:bg-[var(--color-primary-selected-color)] disabled:border-[var(--color-ui-border-color)] disabled:text-[var(--color-disabled-text-color)] disabled:bg-[var(--color-disabled-background-color)]"
      },
      {
        kind: "secondary",
        color: "negative",
        class:
          "border-[var(--color-negative-color)] text-[var(--color-negative-color)] hover:bg-[var(--color-negative-color-selected)] active:bg-[var(--color-negative-color-selected)] disabled:text-[var(--color-disabled-text-color)] disabled:border-[var(--color-ui-border-color)] disabled:bg-[var(--color-disabled-background-color)]"
      },
      {
        kind: "secondary",
        color: "positive",
        class:
          "border-[var(--color-positive-color)] text-[var(--color-positive-color)] hover:bg-[var(--color-positive-color-selected)] active:bg-[var(--color-positive-color-selected)] disabled:text-[var(--color-disabled-text-color)] disabled:border-[var(--color-ui-border-color)] disabled:bg-[var(--color-disabled-background-color)]"
      },
      // Tertiary (ghost)
      {
        kind: "tertiary",
        color: "inverted",
        class:
          "text-[var(--color-primary-text-color)] hover:bg-[var(--color-primary-background-hover-color)] active:bg-[var(--color-primary-selected-color)] disabled:text-[var(--color-disabled-text-color)] disabled:bg-transparent"
      },
      {
        kind: "tertiary",
        color: "primary",
        class:
          "text-[var(--color-primary-text-color)] hover:bg-[var(--color-primary-background-hover-color)] active:bg-[var(--color-primary-selected-color)] active:text-[var(--color-primary-color)] disabled:text-[var(--color-disabled-text-color)] disabled:bg-transparent"
      },
      {
        kind: "tertiary",
        color: "negative",
      ...
      // On-color (filled white pill for use on top of a saturated banner/surface)
      {
        ...
        color: "on-primary",
        class:
          "bg-[var(--color-text-color-on-primary)] text-[var(--color-primary-color)] hover:bg-[var(--color-primary-selected-color)] active:bg-[var(--color-primary-selected-hover-color)] disabled:bg-[var(--color-disabled-background-color)] disabled:text-[var(--color-disabled-text-color)]"
      },
      {
        kind: "primary",
        color: "on-negative",
        class:
          "bg-[var(--color-text-color-on-primary)] text-[var(--color-negative-color)] hover:bg-[var(--color-negative-color-selected)] active:bg-[var(--color-negative-color-selected-hover)] disabled:bg-[var(--color-disabled-background-color)] disabled:text-[var(--color-disabled-text-color)]"
      },
      {
        kind: "primary",
        color: "on-positive",
        class:
          "bg-[var(--color-text-color-on-primary)] text-[var(--color-positive-color)] hover:bg-[var(--color-positive-color-selected)] active:bg-[var(--color-positive-color-selected-hover)] disabled:bg-[var(--color-disabled-background-color)] disabled:text-[var(--color-disabled-text-color)]"
      },
      {
        kind: "primary",
        color: "on-warning",
        class:
          "bg-[var(--color-text-color-on-primary)] text-[var(--color-fixed-dark-color)] hover:bg-[var(--color-warning-color-selected)] active:bg-[var(--color-warning-color-selected-hover)] disabled:bg-[var(--color-disabled-background-color)] disabled:text-[var(--color-disabled-text-color)]"
      },
      ...
      // colored attention-box / banner background.
      {
        ...
        color: "on-inverted",
        class:
          "border-[var(--color-primary-text-color)] text-[var(--color-primary-text-color)] hover:bg-[var(--color-primary-background-hover-color)] active:bg-[var(--color-primary-selected-color)] disabled:border-[var(--color-ui-border-color)] disabled:text-[var(--color-disabled-text-color)] disabled:bg-transparent"
      }
    ],
    defaultVariants: {
      kind: "primary",
  ...
  return (
    ...
    >
      {loading ? (
        ...
        iconLeft && <Icon name={iconLeft} size={iconSize} className="text-current p-0" />
      )}
      {children != null && <span>{children}</span>}
      {!loading && iconRight && (
        <Icon name={iconRight} size={iconSize} className="text-current p-0" />
      )}
    </button>
  )
})
