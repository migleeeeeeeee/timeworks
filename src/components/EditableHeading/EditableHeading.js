...
export const EditableHeading = forwardRef(function EditableHeading({ variant = "h1", weight = "bold", value, defaultValue, onValueChange, onCommit, onKeyDown, onBlur, onFocus, placeholder = "Editable heading", disabled = false, readOnly = false, className, "aria-label": ariaLabel, ...rest }, ref) {
